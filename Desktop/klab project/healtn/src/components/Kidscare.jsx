...
export const clinicsData = [
  { id: 1, image: "/imageh/LifeCare Multi-Speciality Clinic.jpg",
     title: "LifeCare Multi-Speciality Clinic",
      description: "Book now for better health",
       link: "https://www.lifecare.rw/en" 
    },
  { id: 2, 
    image: "/imageh/mercy medical clinic.jpeg",
     title: "mercy medical clinic", 
     description: "Your health starts here",
      link: "https://www.mercymedicalclinic.rw/" 
    },
  { id: 3,
     image: "/imageh/Kidocentric.jpeg",
      title: "Kidocentric", 
      description: "Pharmacy that really delivers", 
      link: "https://www.kidocentric.africa/" 
    },
  { id: 4, 
  ...
  return (
    ...
    <button class="custom-button">Pay-per-visit</button>
            ...
            <div className="caregoes-image">
              <img src="/imageh/kids1.jpg" alt="Nikubwawe Clinic" />
            </div>
            </div>
